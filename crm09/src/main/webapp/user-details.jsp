		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 class="counter text-right m-t-15 text-danger">${percentNotStarted}%</h3>
                    </div>
                    <div class="col-xs-12">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="progress">
							<div class="progress-bar progress-bar-danger" role="progressbar"
								...
								style="width: ${percentNotStarted}%"></div>
						</div>
					</div>
				</div>
			</div>
                ...
                <div class="row">
                        ...
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach var="task" items="${tasks}">
                                	<c:if test="${task.status == 'CHƯA BẮT ĐẦU'}">
                                		<a href="#">
                                			<div class="mail-contnet">
								                <h5>${task.nameTask}</h5>
								                <span class="time">Bắt đầu: ${task.startTask}</span>
								                <span class="time">Kết thúc: ${task.endTask}</span>
								            </div>
                                		</a>
                                	</c:if>
                                </c:forEach>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach var="task" items="${tasks}">
                                	<c:if test="${task.status == 'HOÀN THÀNH'}">
                                		<a href="#">
                                			<div class="mail-contnet">
								                <h5>${task.nameTask}</h5>
								                <span class="time">Bắt đầu: ${task.startTask}</span>
