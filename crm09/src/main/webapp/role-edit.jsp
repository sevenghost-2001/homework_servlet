                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="role" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="role_name" type="text" placeholder="${role.name}" value="${role.name}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="description" type="text" placeholder="${role.description}" value="${role.description}" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">Lưu</button>
                                        <!-- Khi gọi role thì sẽ gọi tới phương thức get với URL:localhost:8080/app/role -->
